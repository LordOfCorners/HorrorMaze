...
var pickUpScript : PickUpNotOculus;

function Start(){
defaultRot = transform.eulerAngles;
openRot = new Vector3 (defaultRot.x, defaultRot.y + DoorOpenAngle, defaultRot.z);
player = GameObject.FindWithTag("Player");
pickUpScript = player.GetComponent("PickUpNotOculus");
}
...
function OnGUI(){
if(pickUpScript.hasKey == false && enter){
//GUI.Label(new Rect(Screen.width/2 - 75, Screen.height - 100, 150, 30), "You do not have the key.");
}
}
